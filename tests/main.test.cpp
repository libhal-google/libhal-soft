...
extern void inert_serial_test();
extern void inert_socket_test();
extern void inert_spi_test();
...
int main()
{
  ...
  hal::inert_serial_test();
  hal::inert_socket_test();
  hal::inert_spi_test();
